...
3. Test with a browser by visiting: [https://YOUR-API-ID.execute-api.us-east-1.amazonaws.com/health](https://YOUR-API-ID.execute-api.us-east-1.amazonaws.com/health)
