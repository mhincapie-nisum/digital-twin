...
Test your API directly in the browser: [https://YOUR-API-ID.execute-api.us-east-1.amazonaws.com/health](https://YOUR-API-ID.execute-api.us-east-1.amazonaws.com/health)
